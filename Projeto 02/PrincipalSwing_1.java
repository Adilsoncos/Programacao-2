...
public class PrincipalSwing extends JFrame {
    ...
    public PrincipalSwing() {
        setTitle("Sistema de Biblioteca Musical");
        setSize(900, 600);
    ...
    private void configurarAbaMusicas() {
        ...
        JButton btnOuvir = new JButton("Ouvir Música (Link)");
    ...
    private void configurarAbaEmprestimos() {
        ...
        JButton btnDevolver = new JButton("Registrar Devolução da Música Selecionada");
